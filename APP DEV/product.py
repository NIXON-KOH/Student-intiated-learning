class Items:
    def __init__(self,name, id_, Image, Stocks, Desc, Type):
        self.__id_ = id_
        self.__name = name
        self.__Image = Image
...
class Product(Items):
    def __init__(self,id_, name,Image, Stocks, Desc, points,Type, categories,RetailCost,gender,ListCost,reviews):
    ...
    def set_Categories(self, points):
        self.__points = points
...
class Rewards(Items):
    def __init__(self,id_, name,Image, Stocks, Desc, Type, Status, points, status):
        super().__init__(id_, name, Image, Stocks, Desc, Type, Status)
        self.__points = points
